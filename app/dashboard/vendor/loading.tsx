...
// Skeleton instan untuk Vendor dashboard — ditampilkan SEBELUM server query DB apapun.
//
...
//
// Dimensi skeleton mengikuti VendorDashboardShell:
//   - Sidebar: w-64 (256px) di desktop, hidden di mobile
//   - Header:  h-16 (64px)
//   - Main:    sisa area
//
// Identik dengan SA loading.tsx — karena VendorDashboardShell
// strukturnya sama dengan DashboardShell (ATURAN 11 — DashboardHeader shared).
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <main className="flex-1 overflow-hidden p-4 lg:p-6">
          ...
          {/* Panel tengah — info toko */}
          <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
            <div className="flex items-center gap-4">
              <div className="h-12 w-12 bg-slate-200 rounded-xl animate-pulse shrink-0" />
            ...
            <div className="border-t border-slate-100 pt-4 space-y-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-4">
                  ...
                  <div className="h-3.5 w-20 bg-slate-200 rounded animate-pulse shrink-0" />
                </div>
              ))}
            </div>
          </div>
