// app/dashboard/superadmin/settings/platform-general/loading.tsx
// Loading skeleton untuk PlatformGeneralPage (Server Component sedang fetch data).
// Dibuat: Sesi #164 — T-029

export default function LoadingPlatformGeneralPage() {
  return (
