...
// Tab Override Config — INHERITED / OVERRIDDEN / LOCKED per key
// CATATAN: Implementasi penuh terintegrasi dengan config_registry (M1).
// Sesi #132: placeholder — grid config akan dimuat dari M1 ConfigService saat ready.
//
  ...
  return (
    <div className="space-y-4 max-w-2xl">
      ...
      <div className="rounded-md border border-dashed p-8 text-center text-sm text-muted-foreground">
        ...
        <p>
          Fitur override config per tenant akan tersedia setelah integrasi
          penuh dengan M1 Config Registry selesai.
        </p>
        <p className="mt-2 text-xs">
          Saat ini semua konfigurasi menggunakan nilai platform default (INHERITED).
        </p>
      </div>
    </div>
  )
