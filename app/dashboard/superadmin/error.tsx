...
// Penangkap kegagalan render untuk SELURUH halaman di Dashboard SuperAdmin — §B1 tabel penempatan berkas.
...
//
// `area="super_admin"` — nilai kolom `app_error_log.area` (NOT NULL), BUKAN nama folder route.
