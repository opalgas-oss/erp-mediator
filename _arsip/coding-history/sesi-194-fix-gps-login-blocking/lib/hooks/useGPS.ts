...
// ARSIP S#194: Hook ini TIDAK DIPAKAI (legacy dari S#049, digantikan getGPSLocation inline
// di useLoginFlow.ts). Komentar "Dipakai oleh login flow" di header = tidak akurat.
// login/page.tsx dan semua komponen login hanya import useLoginFlow, bukan useGPS.
// Dihapus: S#194 FIX HUTANG-GPS-BLOCKING (eliminasi GPS dari critical path login).
