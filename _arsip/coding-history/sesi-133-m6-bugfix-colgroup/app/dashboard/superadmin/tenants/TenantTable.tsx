  ...
  return (
    <div className="rounded-md border overflow-hidden">
      <table className="w-full text-sm table-fixed">
        <colgroup>
          <col className="w-[220px]" />  {/* Nama Brand */}
          <col className="w-[120px]" />  {/* Kode */}
          <col className="w-[80px]"  />  {/* Tipe */}
          <col className="w-[80px]"  />  {/* Tier */}
          <col className="w-[140px]" />  {/* PIC */}
          <col className="w-[100px]" />  {/* Status */}
          <col className="w-[48px]"  />  {/* Aksi */}
        </colgroup>
