...
// File asli: app/dashboard/superadmin/layout.tsx
// Snapshot: 27 April 2026
// Masalah:
//   M1 — getConfigValue() dipanggil setiap request hanya untuk baca TTL (~50-80ms cold)
//   M2 — unstable_cache() dibuat ulang di dalam component function setiap render
//   M3 — dua await sequential: getConfigValue → getSidebarData (tidak bisa diparallelkan)
