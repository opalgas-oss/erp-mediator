...
//
// Update: Sesi #299 — Tambah getConfigItemsByKategori() untuk Deep Metrics capacity config.
//   Solusi Opsi A: baca semua item satu kategori sekaligus (bukan per feature_key).
