// app/api/superadmin/tenants/[id]/categories/route.ts — PRE-EDIT ARSIP S#180
// BUG: catch POST includes 'tidak ditemukan' dalam isValidation → return 400 (harusnya 404)
...
export async function POST(
  ...
  try {
    ...
    // BUG AKTIF: 'tidak ditemukan' masuk isValidation → return 400 (harusnya 404)
