...
// Label opsi OTP mode — S#209 (TDD-Q1)
// Berlaku untuk require_otp + require_otp_superadmin.
// Fallback ?? opt menjaga backward compat untuk field lain (biometric_mode dll).
