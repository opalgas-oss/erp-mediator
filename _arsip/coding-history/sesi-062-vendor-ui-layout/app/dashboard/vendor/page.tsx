'use client'
// ARSIP SESI #062 — app/dashboard/vendor/page.tsx
// Alasan: Hapus logout button standalone (pindah ke DashboardHeader),
// simplify menjadi content area saja (keputusan Philips Sesi #062)
...
export default function VendorPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-10 text-center">
      ...
      <h1 className="text-lg font-semibold text-gray-900 mb-1">{msg['vendor_page_title']}</h1>
      <p className="text-sm text-gray-400 mb-6">{msg['vendor_page_subtitle']}</p>
