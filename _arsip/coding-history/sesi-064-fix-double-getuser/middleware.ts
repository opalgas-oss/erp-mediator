// ⚠️ ARSIP SESI #064 — SEBELUM FIX DOUBLE getUser()
// File asli: middleware.ts (root project)
// Snapshot diambil: 27 April 2026
// Alasan: Fix double getUser() — middleware.ts akan diubah untuk propagate
//         user data via request headers ke downstream Server Components
