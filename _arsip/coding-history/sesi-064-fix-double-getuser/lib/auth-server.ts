...
// File asli: lib/auth-server.ts
// Snapshot diambil: 27 April 2026
// Alasan: Fix double getUser() — auth-server.ts akan diubah untuk baca
//         x-user-* headers dari middleware sebelum call getUser() ke Supabase
