...
// Sheet — Side Panel drawer berbasis Radix Dialog.
// Paket: radix-ui (umbrella) sudah terinstall (sama dengan dialog.tsx).
// Dipakai oleh: DropdownDetailDrawer.tsx (Side Peek drawer M4)
//
// Dibuat: Sesi #127 — L3.1 (redo dari S#126 yang filesystem write gagal)
